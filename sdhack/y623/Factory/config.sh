#!/bin/sh
# First-install bootstrap for the exact audited y623 firmware. Unknown internal
...
EXPECTED_LEGACY_INIT_MD5='e9bc4d10f495f7aca0e5d8bb46e2ad35'
...
verify_or_absent /backup/tools/upgrade.sh 669fdf31a9e8dce912d0e0d5a2446887
verify_or_absent /backup/tools/extpkg.sh f8e34db03a56a11b5229ea40eb661bef
...
preserve_file /backup/tools/upgrade.sh 669fdf31a9e8dce912d0e0d5a2446887 backup_tools_upgrade.sh
preserve_file /backup/tools/extpkg.sh f8e34db03a56a11b5229ea40eb661bef backup_tools_extpkg.sh
...
remove_verified /backup/tools/upgrade.sh 669fdf31a9e8dce912d0e0d5a2446887
remove_verified /backup/tools/extpkg.sh f8e34db03a56a11b5229ea40eb661bef
